...
import math
from modules.base import SELayer
...
class SEBottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, BatchNorm=None, reduction=16):
...
def build_contextpath(model, inplanes=64, output_stride=16, pretrained=True, sync_bn=False):
    ...
    elif model == 'resnet101_se':
        return ResNet(SEBottleneck, inplanes, [3, 4, 23, 3], output_stride, BatchNorm, pretrained=pretrained)
